...
public class StockItem {
    ...
    public int reserveStock(int quantityToReserved) throws UnavailableStockException {
        if (quantityToReserved <= availableQuantity()) {
            this.reserved += quantityToReserved;
            return quantityToReserved;
        }
        throw new UnavailableStockException("The quantity that you wanna reserved is not available ");
    }
    ...
    public int unreserveStock(int quantity) {
        ...
        throw new StockNoteReservedException("The quantity that you wanna unreserve is to big ");
    }
    ...
    public int finalizeStock(int quantity) {
        ...
        throw new StockNoteReservedException("The should be reserved first ");
    }
